...
describe('ProductsController', () => {
  ...
  describe('findAll', () => {
      ...
      it('should create a new product', () => {
        const newProduct: Product = { id: '1', nombre:"a24",marca:"Samsung", descripcion:"celular", precio: 25, stock: 50 };
      ...
      it('should update an existing product', () => {
        const initialProduct: Product = {id: '1', nombre:"a24",marca:"Samsung", descripcion:"celular", precio: 25, stock: 50 };
        productsService.create(initialProduct);
        const updatedProductData: Product = { id: '1', nombre:"a24",marca:"Samsung", descripcion:"celular", precio: 25, stock: 51 };
      ...
      it('should delete an existing product', () => {
        const productToDelete: Product = {id: '1', nombre:"a24",marca:"Samsung", descripcion:"celular", precio: 25, stock: 51};
